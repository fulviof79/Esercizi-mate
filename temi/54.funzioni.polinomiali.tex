...
\begin{questions}
	...
	\begin{qblock}
		\question
		\exonly{
			Scomporre in fattori i polinomi seguenti:
		}
		...
		\begin{multicols}{2}
			\begin{parts}
				...
				\solonly{$(x + 1) (x + 2) (x - 4)$ \\ $S=\left\lbrace -2,-1,4\right\rbrace $}

				\part
				\exonly{$x^3 + x^2 -14x -24 $ }
				\solonly{$(x - 4) (x + 2) (x + 3) $ \\ $S=\left\lbrace -3,-2,4\right\rbrace $}

				\part
				\exonly{$2 x^3 - 3 x^2 - 17 x + 30 $ }
				\solonly{$(x - 2) (x + 3) (2 x - 5)$ \\$S=\left\lbrace -3,2,\dfrac{5}{2}\right\rbrace $}

				\part
				\exonly{$12x^3+8x^2-3x-2$ }
				\solonly{ $(3x+2)(2x-1)(2x+1) $ \\ $S=\left\lbrace -\dfrac{2}{3},-\dfrac{1}{2},\dfrac{1}{2}\right\rbrace $ }
...
\begin{questions}
	...
	\begin{parts}
		...
		\ifprintanswers
			\input{tikz/funzioni.polinomiali.1}
		\fi

		\part
		\exonly{$f_2(x)=-x^3 - x^2 +14x +24$ }
		\ifprintanswers
			\input{tikz/funzioni.polinomiali.2}
		\fi
		...
		\ifprintanswers
			\input{tikz/funzioni.polinomiali.3}
		\fi
...
\begin{questions}
	...
	\begin{parts}
		...
		\solonly{$f(x)=-(x-1)^2(x-3)$
			\newline
			Massimo locale $(2.33;1.19)$ , Minimo locale $(1;0)$
