...
\exonly{
	...
	\begin{parts}
		...
		\part \exonly{$f(x)=2x^4-3x^2+5$ }
		\part \exonly{$f(x)=(x+3)^2$ }
		\part \exonly{$f(x)=(2x-3)(3x+4)$ }
		\part \exonly{$f(x)=(x^2-3x+2)(2x-5)$ }
	\end{parts}
...
\exonly{	Determinare la derivata delle seguenti funzioni reali:
	...
	\begin{multicols}{2}
		\begin{parts}
			...
			\part $ f(x)=3x+2 $
			\part $ f(x)=-2x+4 $
			\part $ f(x)=-\frac{5}{3}x+\frac{4}{3} $
			\part $ f(x)=2x^2+3x+4 $
			\part $ f(x)=-3x^2-7x+5 $
			\part $ f(x)=-3x^2-7x-2 $
			\part $ f(x)=4x^3-2x^2+5 $
			\part $ f(x)=2x^4-3x^2+3 $
			\part $ f(x)=x^4-3x^3+x^2-5x+1 $
		\end{parts}
\end{multicols}
 }
...
\begin{multicols}{2}
	\begin{parts}
		...
		\part $ f(x)=5\times 7^{x} $
		\part $ f(x)=\ex{-x} $
		\part $ f(x)=2\cdot \ex{3x-5} $
		\part $ f(x)=\ex{-2x+3} $
		\part $ f(x)=10^{x^2} $
		\part $ f(x)=(\ex{x})^2 $
		\part $ f(x)=\ex{2x+1} \cdot \ex{x+2} $
...
\exonly{
	...
	\begin{parts}
		\part Determinare la velocità in funzione del tempo $v(t)=\dot{x}(t) $.
		\part Determinare l'altezza massima raggiunta.
		\part Determinare l'accelerazione in funzione del tempo $a(t)=\ddot{x}(t) $.
	\end{parts}
...
\question
\exonly{Determinare sull’arco di un settore di raggio $r=OA=OB$ e angolo $\alpha=\angle AOP<90\degree$ un punto $P$ per cui sia massima la somma delle distanze dai lati del settore $KP+HP$.  
...
\solonly{ $\dfrac{9}{4}-\ln(8)\approx 01705$}
