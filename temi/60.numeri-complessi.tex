...
\begin{questions}
	...
	\begin{qblock}
		...
		\exonly{	Sono date le intensità di corrente:
			...
			\begin{align*}
				I_1(t) & =\SI{1.2}{A} \cdot \sin{\left(100\pi \si{s^{-1}} \cdot t + \frac{\pi}{4}\right)} \\
				I_2(t) & =\SI{0.7}{A}\cdot \sin{\left(100\pi \si{s^{-1}} \cdot t + \frac{\pi}{2}\right)}  
			\end{align*} }
	
	
		\exonly{Determina  $I(t)=I_1(t) + I_2(t)$
	
			Verifica la correttezza del risultato con la calcolatrice, Desmos o GeoGebra }
		\solonly{$I(t)=1.7658 \sin\left(100\pi t+0.0695\right)$ }
\end{qblock}
...
\begin{qblock}
		...
		\exonly{	Sono date le intensità di corrente:
			...
			\begin{align*}
				I_1(t) & =\SI{1.5}{A} \cdot \sin{\left(100\pi \si{s^{-1}} \cdot t + \frac{\pi}{3}\right)} \\
				I_2(t) & =\SI{0.8}{A}\cdot \sin{\left(100\pi \si{s^{-1}} \cdot t + \frac{\pi}{6}\right)}  \\
				I_3(t) & =\SI{0.5}{A}\cdot \sin{\left(100\pi \si{s^{-1}} \cdot t + \frac{\pi}{4}\right)}
			\end{align*} }
