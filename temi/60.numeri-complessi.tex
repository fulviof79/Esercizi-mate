...
\begin{parts}
	\part 
	 ...
	 \solonly{$10 \mathrm{e}^{-\mathrm{j} \pi / 3}$ }

\part\exonly{ $3+4 j$ }
\solonly{$5 \mathrm{e}^{\mathrm{j\varphi}} \operatorname{con} \varphi=\tan ^{-1} 4 / 3 \approx 0,92 \mathrm{rad}$ }

\part \exonly{$-6-6 j$ }
\solonly{$6 \sqrt{2} \mathrm{e}^{-\mathrm{j} 3 \pi / 4}$ }
\part \exonly{$-5-12 j$ }
\solonly{$12 \mathrm{e}^{\mathrm{j\varphi}}$ con $\varphi=-\pi+\tan ^{-1} 12 / 5 \approx-1,96 \mathrm{rad}$ }
\part  \exonly{$-4 \sqrt{3}+4 j$ }
\solonly{$8 e^{j 5 \pi / 6}$ }

\part \exonly{$6 \mathrm{e}^{\mathrm{j} \pi / 6}$ }
\solonly{$3 \sqrt{3}+3 j$ }
\part \exonly{ $7 \sqrt{2} \mathrm{e}^{-\mathrm{j} \pi / 4}$ }
\solonly{$7-7 j$ }
\part \exonly{ $10 \mathrm{e}^{\mathrm{j} 2 \pi / 3}$ }
\solonly{$-5+5 \sqrt{3} j$ }
\part \exonly{$8 \mathrm{e}^{-\mathrm{j} 3 \pi / 2}$ }
\solonly{$8\mathrm{j}$ }
\part \exonly{$4 \mathrm{e}^{\mathrm{j} \pi / 12}$ }
\solonly{$\sqrt{2}[\sqrt{3}+1+j(\sqrt{3}-1)]$ }
...
\begin{questions}
	...
	\begin{multicols}{2}	
		\begin{parts}
			...
			\part \exonly{$b-c=$ }
			\part \exonly{$a+b-c+d=$ }
			\part \exonly{$(a-b)\cdot(c-d)=$ }
			\part \exonly{$\frac{b}{c}=$ }
			\part \exonly{$\frac{a-c}{b+d}=$ }
		\end{parts}	
	\end{multicols}	
...
\begin{parts}
	...
	\part \exonly{$\sqrt[4]{-\frac{1}{2}+\frac{\sqrt{3}}{2}} $}
