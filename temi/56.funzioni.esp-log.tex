...
Vogliamo modellizzare la funzione $L(x)$ che ci darà la lunghezza della molla (in \SI{}{\centi\meter}) in funzione della massa sospesa (in \SI{}{\kilogram}). Con che tipo di modello abbiamo a che fare? Lineare o esponenziale?
...
\question
\exonly{
Il numero di batteri in una coltura cresce esponenzialmente. Trenta minuti dopo l'inizio dell'esperienza ci sono 1500 batteri e dopo quaranta minuti se ne stimano 2000.
}

\begin{parts}
\part
\exonly{
Quanti batteri c'erano inizialmente ($t=0$)? 
}
