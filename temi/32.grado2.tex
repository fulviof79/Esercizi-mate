	...
	\begin{qblock}
		...
		\begin{multicols}{2}
			\begin{parts}
				...
				\solonly{$\es{\frac{2 \pm \sqrt{89}}{5}}$}
...
\begin{qblock}
		...
		\solonly{ Utilizzare calcolatrice grafica o software di grafico per il confronto.}
\end{qblock}
...
\begin{qblock}
		...
		\exonly{ Determinare l'equazione della legge delle funzioni di cui sono dati i grafici:
		}
		\begin{multicols}{2}
			\begin{parts}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(1,-1) (2,-1) (3,1) (0,1) (4,5) (-1,5)};
						\end{axis}
					\end{tikzpicture}
				}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(-3,-4) (-2,2) (-1,4) (0,2) (1,-4) };
						\end{axis}
					\end{tikzpicture}
				}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(0,-1) (2,1) (4,-1)  };
						\end{axis}
					\end{tikzpicture}
				}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(1,6)} node[below right]{$(1;6)$};
							\addplot[only marks, mark=*] coordinates {(0,-3) (-2,-3) (-3,6) };
						\end{axis}
					\end{tikzpicture}
				}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(-2,0) (0,4) (-1,4) (1,0) };
						\end{axis}
					\end{tikzpicture}
				}
				...
				\exonly{
					\begin{tikzpicture}[baseline={($(current bounding box.north)-(0,1.6ex)$)}]
						\begin{axis}[
							...
							\addplot[only marks, mark=*] coordinates {(-2,6) (0,0) (2,-2) (4,0) (6,6) };
						\end{axis}
					\end{tikzpicture}
				}
