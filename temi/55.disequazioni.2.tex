...
\begin{questions}
	...
	\begin{qblock}
		\question
		\exonly{Dato il grafico della funzione  $f : \R \longrightarrow \R$  risolvere graficamente la disequazione segunte:
			$$f(x)<3$$
	...
	\begin{qblock}
		\question
		\exonly{Dato il grafico della funzione  $f : \R \longrightarrow \R$ risolvere graficamente la disequazione seguente: $$ f(x)+1 \geq 0$$
	...
	\begin{qblock}
		\question
		\exonly{Dato il grafico della funzione  $f : \R \longrightarrow \R$  risolvere graficamente la disequazione segunte: $$ f(x) -\frac{1}{2}x \geq -1$$
