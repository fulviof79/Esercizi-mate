...
%\end{parts}
%
%\exonly{\includegraphics[width=\linewidth]{triangle-rect-intro}	}
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%TODO : convert in TikZ
\exonly{\includegraphics[width=0.5\linewidth]{aac-1}}
...
\exonly{\includegraphics[width=0.6\linewidth]{aac-2}}
