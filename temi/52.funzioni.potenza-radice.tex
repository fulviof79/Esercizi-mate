...
\begin{questions}
	...
	\begin{parts}
		\part
		\exonly{$f(x)=x^6$}
		\solonly{$f^{-1}(x)=\sqrt[6]{x}$  biettiva su \\ $\DD_f=[0;\infty[$ e $\DD_{f^{-1}}=[0;\infty[$}
		
		\part
		\exonly{$f(x)=(x-1)^2 +2 $}
		\solonly{$f^{-1}(x)=\sqrt{x-1}+1$  biettiva su \\  $\DD_f=[1;\infty[$  e $\DD_{f^{-1}}=[2;\infty[$}
		
		\part
		\exonly{$f(x)=(x-2)^3-1$}
		\solonly{$f^{-1}(x)=\sqrt[3]{x+1}+2$ biettiva su \\  $\DD_f=[-\infty;\infty[$}
	\end{parts}
